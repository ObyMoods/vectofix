...
class _TiktokDownloaderPageState extends State<TiktokDownloaderPage> {
  ...
  final Color primaryDark = Color(0xFF7F1D1D);
  final Color primaryBlue = Color(0xFFB91C1C);
  final Color accentBlue = Color(0xFFEF4444);
  final Color lightBlue = Color(0xFFFCA5A5);
