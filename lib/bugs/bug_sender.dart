...
class _BugSenderPageState extends State<BugSenderPage> {
  ...
  Future<void> _fetchSenders() async {
    ...
    try {
      final response = await http.get(
        Uri.parse("http://kiluastecuuujirr.omdhanange.my.id:2251/mySender?key=${widget.sessionKey}"),
  ...
  Future<void> _addSender(String number, String name) async {
    ...
    try {
      final response = await http.get(
        Uri.parse("http://kiluastecuuujirr.omdhanange.my.id:2251/getPairing?key=${widget.sessionKey}&number=$number"),
      );
    ...
    if (confirmed == true) {
      ...
      try {
        ...
        final response = await http.delete(
          Uri.parse("http://kiluastecuuujirr.omdhanange.my.id:2251/deleteSender?key=${widget.sessionKey}&id=$senderId"),
        );
