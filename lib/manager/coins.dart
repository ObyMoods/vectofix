...
class _CoinManagePageState extends State<CoinManagePage> {
  ...
  Future<void> _fetchCoinBalance() async {
    ...
    try {
      final response = await http.get(
        Uri.parse('http://kiluastecuuujirr.omdhanange.my.id:2251/refreshCoins?key=${widget.sessionKey}'),
      );
  ...
  try {
    final response = await http.get(
      Uri.parse('http://kiluastecuuujirr.omdhanange.my.id:2251/redeem?key=${widget.sessionKey}&code=$code'),
    ).timeout(
  ...
  Future<void> _giftCoin() async {
    ...
    try {
      ...
      final response = await http.post(
        Uri.parse('http://kiluastecuuujirr.omdhanange.my.id:2251/giftCoin'),
        headers: {
